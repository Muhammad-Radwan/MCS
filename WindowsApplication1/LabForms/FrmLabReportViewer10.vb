Public Class FrmLabReportViewer10

    Private Sub CrystalReportViewer1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CrystalReportViewer1.Load
        'Dim cr1 As New CrystalReport16, cri As String
        'If vv = 1 Then
        'cri = "{PHARMACY.FNUMBER}=" & "'" & vv1 & "'"
        '    cri = "{appointment.fnumber}=" & "'" & vv1 & "'" & " and {MAIN.FNUMBER}= " & "'" & vv1 & "'"
        'cri = "{MAIN.FNUMBER}= " & "'" & vv1 & "'" & " and {cbc.fnumber}=" & "'" & vv1 & "'"
    ...
    Private Sub FrmLabReportViewer10_Load(sender As Object, e As EventArgs) Handles MyBase.Load
