...
Public Class CrystalReport48
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCS.CrystalReport48.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport48
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport48 = New CrystalReport48()
        rpt.Site = Me.Site
        Return rpt
    End Function
