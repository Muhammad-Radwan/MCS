...
Public Class CrystalReport39
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCS.CrystalReport39.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport39
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport39 = New CrystalReport39()
        rpt.Site = Me.Site
        Return rpt
    End Function
