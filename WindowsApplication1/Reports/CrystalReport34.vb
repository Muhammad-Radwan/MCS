...
Public Class CrystalReport34
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCS.CrystalReport34.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport34
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport34 = New CrystalReport34()
        rpt.Site = Me.Site
        Return rpt
    End Function
