...
Public Class CrystalReport54
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCS.CrystalReport54.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport54
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport54 = New CrystalReport54()
        rpt.Site = Me.Site
        Return rpt
    End Function
