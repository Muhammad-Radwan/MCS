...
Public Class CrystalReport32
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCS.CrystalReport32.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport32
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport32 = New CrystalReport32()
        rpt.Site = Me.Site
        Return rpt
    End Function
