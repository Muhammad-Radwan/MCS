...
Public Class CrystalReport38
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCS.CrystalReport38.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport38
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport38 = New CrystalReport38()
        rpt.Site = Me.Site
        Return rpt
    End Function
