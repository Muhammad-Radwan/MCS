...
Public Class CrystalReport36
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCS.CrystalReport36.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReport36
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport36 = New CrystalReport36()
        rpt.Site = Me.Site
        Return rpt
    End Function
